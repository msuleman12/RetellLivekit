"""Post-call analysis fields for each practice area, and the JSON schema built from them."""
...
ACCIDENT_FIELDS: tuple[AnalysisField, ...] = (
    ...
    F("accident_date", "The date the incident happened. Relative dates resolved from the call date, written like 'December 23, 2025'.", examples=("December 23, 2025", "around December 20, 2025"), conditional_prompt="Only populate if the matter involves an incident with a date."),
    ...
    F("incident_city", "The city the incident happened in, as the caller said it. City alone, plus the state if they gave one - not a street address.", examples=("Dallas", "Fort Worth, TX"), conditional_prompt="Only populate if the caller named a city."),
...
EMPLOYMENT_FIELDS: tuple[AnalysisField, ...] = (
    ...
    F("employment_start_date", "When the caller started working there. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if mentioned."),
    F("employment_end_date", "When employment ended, if it did. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if the employment ended and a date/timeframe was given."),
    ...
    F("incident_city", "The city the workplace or the events are in, as the caller said it. City alone, plus the state if they gave one - not a street address.", examples=("Dallas", "Fort Worth, TX"), conditional_prompt="Only populate if the caller named a city."),
...
PREMISES_FIELDS: tuple[AnalysisField, ...] = (
    ...
    F("premises_incident_date", "The date the incident happened. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if mentioned."),
...
MALPRACTICE_FIELDS: tuple[AnalysisField, ...] = (
    ...
    F("mm_incident_date", "When the incident happened. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if mentioned."),
    ...
    F("incident_city", "The city the care was given in, as the caller said it. City alone, plus the state if they gave one - not a street address.", examples=("Dallas", "Fort Worth, TX"), conditional_prompt="Only populate if the caller named a city."),
    ...
    F("mm_symptom_onset", "When symptoms or complications first appeared. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if mentioned."),
...
HARASSMENT_FIELDS: tuple[AnalysisField, ...] = (
    ...
    F("sh_incident_dates", "When the incidents occurred. Relative dates resolved from the call date, written like 'December 23, 2025'.", conditional_prompt="Only populate if mentioned."),
    ...
    F("incident_city", "The city the incidents happened in, as the caller said it. City alone, plus the state if they gave one - not a street address.", examples=("Dallas", "Fort Worth, TX"), conditional_prompt="Only populate if the caller named a city."),
